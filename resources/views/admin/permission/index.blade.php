...
@section('content')
            ...
            <div class="row page-title-row" id="dangqian" style="margin:5px;">
                ...
                <div class="col-md-6 text-right">
                    <a href="{{ url('/admin/permission/'.$cid.'/create') }}" class="btn btn-success btn-md"><i class="fa fa-plus-circle"></i> 添加权限 </a>
                </div>
            </div>
        ...
        <div class="modal-dialog modal-warning">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form class="deleteForm" method="POST" action="{{ url('/admin/list') }}">
